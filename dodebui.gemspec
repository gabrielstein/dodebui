...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Docker Debian builder (DoDeBui): Builds debian packages in Docker containers}
  spec.description   = %q{Docker Debian builder (DoDeBui): Builds debian packages in Docker containers}
